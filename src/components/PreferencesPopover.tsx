      ...
      <div className="bg-card/95 backdrop-blur-md border border-border rounded-md shadow-2xl overflow-hidden">
        ...
        <div className="p-3 flex flex-col gap-3">
          ...
          <div className="border-t border-border pt-3">
            <div className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground/60 mb-2">Startup</div>
            <label className="flex items-center justify-between gap-3 px-2.5 py-2 rounded-md bg-muted/20 border border-transparent hover:bg-muted/40 transition-all cursor-pointer">
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col gap-0.5">
                  <div className="text-[11px] font-bold text-foreground">Start on Welcome Screen</div>
                  <div className="text-[10px] text-muted-foreground/80 leading-tight">Always show welcome screen when sidebar opens</div>
                </div>
              </div>
              <input
                type="checkbox"

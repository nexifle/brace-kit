...
nav_groups = [
    ...
    { title = "Core Features", items = [
        ...
        { label = "Builder", url = "/guide/core-features/slide-creator/", icon = "<svg width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2'><rect x='3' y='4' width='18' height='14' rx='2'/><path d='M8 21h8'/><path d='M12 18v3'/></svg>" },
